...
#include "DNAWireframeInteraction.h"
#include <sstream>
#include <fstream>
...
DNAWireframeInteraction::DNAWireframeInteraction() : DNA2Interaction() { // @suppress("Class members should be properly initialized")
    // TODO: Re-examine These
    //Protein Methods Function Pointers
    _int_map[SPRING] = (number (DNAInteraction::*)(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces)) &DNAWireframeInteraction::_protein_spring;
    _int_map[SPRING] = (number (DNAInteraction::*)(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces)) &DNAWireframeInteraction::_protein_spring;
    _int_map[PRO_EXC_VOL] = (number (DNAInteraction::*)(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces)) &DNAWireframeInteraction::_protein_exc_volume;

    //Protein-DNA Function Pointers
    _int_map[PRO_DNA_EXC_VOL] = (number (DNAInteraction::*)(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces)) &DNAWireframeInteraction::_protein_dna_exc_volume;

    //DNA Methods Function Pointers
    _int_map[BACKBONE] = (number (DNAInteraction::*)(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces)) &DNAWireframeInteraction::_backbone;
    _int_map[COAXIAL_STACKING] = (number (DNAInteraction::*)(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces))  &DNAWireframeInteraction::_coaxial_stacking;
    _int_map[CROSS_STACKING] = (number (DNAInteraction::*)(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces))  &DNAWireframeInteraction::_cross_stacking;
    _int_map[BONDED_EXCLUDED_VOLUME] = (number (DNAInteraction::*)(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces))  &DNAWireframeInteraction::_bonded_excluded_volume;
    _int_map[STACKING] = (number (DNAInteraction::*)(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces))  &DNAWireframeInteraction::_stacking;
    _int_map[HYDROGEN_BONDING] = (number (DNAInteraction::*)(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces))  &DNAWireframeInteraction::_hydrogen_bonding;
    _int_map[NONBONDED_EXCLUDED_VOLUME] = (number (DNAInteraction::*)(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces))  &DNAWireframeInteraction::_nonbonded_excluded_volume;
    _int_map[DEBYE_HUCKEL] = (number (DNAInteraction::*)(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces))  &DNAWireframeInteraction::_debye_huckel;
}


void DNAWireframeInteraction::get_settings(input_file &inp){
...
void DNAWireframeInteraction::check_input_sanity(std::vector<BaseParticle*> &particles){
...
void DNAWireframeInteraction::allocate_particles(std::vector<BaseParticle*> &particles) {
    if (ndna==0 || ndnas==0) {
...
void DNAWireframeInteraction::read_topology(int *N_strands, std::vector<BaseParticle*> &particles) {
    ...
    if (head.fail()) throw oxDNAException("Problem with header make sure the format is correct for DNAWireframe Interaction");

    if(my_N_strands < 0 || my_N_strands > my_N || ndna > my_N || ndna < 0 || npro > my_N || npro < 0 || ndnas < 0 || ndnas > my_N) {
        throw oxDNAException("Problem with header make sure the format is correct for DNAWireframe Interaction");
    }
...
number DNAWireframeInteraction::pair_interaction(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces){
...
number DNAWireframeInteraction::pair_interaction_bonded(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces) {
    if(compute_r)
...
number DNAWireframeInteraction::pair_interaction_nonbonded(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces) {
    if (compute_r)
        _computed_r = this->_box->min_image(p->pos, q->pos);
...
number DNAWireframeInteraction::_protein_dna_exc_volume(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces)
{
...
number DNAWireframeInteraction::_protein_dna_repulsive_lj(const LR_vector &r, LR_vector &force, bool update_forces, number &sigma, number &b, number &rstar, number &rcut, number &stiffness) {
...
void DNAWireframeInteraction::init() {
...
number DNAWireframeInteraction::_protein_repulsive_lj(const LR_vector &r, LR_vector &force, bool update_forces) {
    // this is a bit faster than calling r.norm()
...
number DNAWireframeInteraction::_protein_exc_volume(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces) {
    LR_vector force(0,0,0);
...
number DNAWireframeInteraction::_protein_spring(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces) {
...
DNAWireframeInteraction::~DNAWireframeInteraction() {
}
