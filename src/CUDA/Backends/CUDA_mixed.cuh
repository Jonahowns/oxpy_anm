...
__global__ void first_step_mixed(float __restrict__ *massesInv, float4 __restrict__ *poss, GPU_quat __restrict__ *orientations, LR_double4 __restrict__ *possd,
